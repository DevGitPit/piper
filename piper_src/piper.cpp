...
namespace {
constexpr const char *LOG_TAG = "PiperNative";
...
struct piper_synthesizer *piper_create(const char *model_path,
    ...
    // Load onnx model with performance optimizations for mobile ARM CPUs
    ...
    return synth;
        ...
        log_error(std::string("piper_create exception: ") + e.what());
        return nullptr;
    } catch (...) {
        log_error("piper_create unknown exception");
        return nullptr;
    }
}
...
int piper_synthesize_start(struct piper_synthesizer *synth, const char *text,
    ...
    return PIPER_OK;
        ...
        log_error(std::string("piper_synthesize_start exception: ") + e.what());
        return PIPER_ERR_GENERIC;
    } catch (...) {
        log_error("piper_synthesize_start unknown exception");
        return PIPER_ERR_GENERIC;
    }
}
...
int piper_synthesize_next(struct piper_synthesizer *synth,
    ...
    return PIPER_OK;
        ...
        log_error(std::string("piper_synthesize_next exception: ") + e.what());
        return PIPER_ERR_GENERIC;
    } catch (...) {
        log_error("piper_synthesize_next unknown exception");
        return PIPER_ERR_GENERIC;
    }
}
